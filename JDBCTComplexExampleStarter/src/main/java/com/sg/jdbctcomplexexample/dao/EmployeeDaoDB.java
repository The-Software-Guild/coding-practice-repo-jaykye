...
public class EmployeeDaoDB implements EmployeeDao {
    ...
    public static final class EmployeeMapper implements RowMapper<Employee> {
        ...
        @Override
        public Employee mapRow(ResultSet rs, int index) throws SQLException {  // rs가 그냥 row나 마찬가지 idx, row in df.iterrows() 생각하면 됨.)
    ...
    public Employee getEmployeeById(int id) {
        try {
            ...
            return jdbc.queryForObject(SELECT_EMPLOYEE_BY_ID, new EmployeeMapper(), id); // 딱 하나만 return하게 되어있따.

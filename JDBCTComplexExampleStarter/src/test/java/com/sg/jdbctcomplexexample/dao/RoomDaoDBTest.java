...
class RoomDaoDBTest {
    ...
    // This is roomDao test but need others for the complex objects.
    @Autowired
    RoomDao roomDao;
    ...
    @Before
    public void setUp() {
        // 여기서 따로 establish connection 하기 싫은가보다. 그래서 getAllRooms 사용함 (which internally establish connection.)

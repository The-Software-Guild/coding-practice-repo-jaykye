...
public class HappyLlamas {
    ...
    public static boolean areTheLlamasHappy(boolean ultraBouncy, int trampolines) {
        boolean trampolinesOverMin = trampolines >= 24;
        boolean trampolinesBelowMax = trampolines <= 42;
        if ((ultraBouncy && trampolinesOverMin) || (!ultraBouncy && trampolinesOverMin && trampolinesBelowMax)) {
            return true;
        }
        return false;
    }
